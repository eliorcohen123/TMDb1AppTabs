...
class AppRater {
    ...
    private final static String APP_TITLE = "Lovely Movies Info";// App Name
    private final static String APP_PNAME = "eliorcohen.com.tmdbapp";// Package Name
    ...
    static void app_launched(Context mContext) {
        ...
        if (launch_count >= LAUNCHES_UNTIL_PROMPT) {
            if (System.currentTimeMillis() >= date_firstLaunch +
                    (MILLISECONDS_UNTIL_PROMPT * 5 * 60 * 1000)) {
